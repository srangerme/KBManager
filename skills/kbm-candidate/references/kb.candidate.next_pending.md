...
```bash
python3 /home/sranger/codes/claude-code-marketplace/plugins/kbm/scripts/kbmanager_plugin.py kb.candidate.next_pending /path/to/empty-payload.json --pretty
```
