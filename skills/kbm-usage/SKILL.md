...
- KBManager 将用户数据存为 Markdown、PDF、YAML 和派生索引文件。
...
{  "title": "<knowledgebase title>",
  "input_path": "<temporary definition file-or-directory>",
  "knowledgebase_id": "kb-..."
}
```
...
- 创建 knowledgebase 时，用户给出的 source/file/directory 只是临时 definition context。
